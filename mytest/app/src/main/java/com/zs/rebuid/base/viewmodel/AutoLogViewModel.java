...
import com.zs.rebuid.base.biz.autolog.IAutoLogContract;
 ...
 */
public class AutoLogViewModel implements IAutoLogContract.IModel {

    TcpRequestAdapter adapter;
    @Override
    public void getAutoLog(int id, ICallback<DevBean> callback) {
        adapter.getAutoLog(id,callback);
    }
}
